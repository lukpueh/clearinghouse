...
from clearinghouse.node_state_transitions import transition_onepercentmanyevents_to_canonical
...
vessels_dict_basic[mockutil.extra_vessel_name] = {"userkeys" : [node_transition_lib.transition_state_keys['onepercentmanyevents']],
                                                  ...
                                                  "status" : "",
                                                  "advertise" : True}
vessels_dict_basic["vessel_non_clearinghouse"] = {"userkeys" : [node_transition_lib.transition_state_keys['onepercentmanyevents']],
