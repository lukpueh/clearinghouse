"""
<Program>
  test_twopercent_to_twopercent.py

<Purpose>
  Test out the twopercent_to_topercent transition state. 
...
vessels_dict = {}
vessels_dict[mockutil.extra_vessel_name] = {"userkeys" : [node_transition_lib.transition_state_keys['twopercent']],
