...
urlpatterns = patterns('',
    ...
    url(r'^html/', include('seattlegeni.website.html.urls')),
    url(r'^download/', include('seattlegeni.website.html.downloadurls')),
    url(r'^xmlrpc', include('seattlegeni.website.xmlrpc.urls')),
